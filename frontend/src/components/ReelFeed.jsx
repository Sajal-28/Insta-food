                ...
                <div className="reel-overlay">
                  ...
                  <div className="reel-actions">
                    ...
                    <div className="reel-action-group">
                      ...
                      <div className="reel-action__count">{item.saveCount ?? item.bookmarks ?? item.save ?? 0}</div>
                    </div>
                  ...
                  <div className="reel-content">
                    <div className="reel-meta">
                      <span className="reel-chip">Featured dish</span>
                      <span className="reel-chip reel-chip--muted">Short reel</span>
                    </div>
